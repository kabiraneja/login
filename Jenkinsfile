    ...
    stages {
        ...
        stage('Deploy to Docker') {
            steps {
                ...
                sh ' scp -i id_rsa /var/jenkins_home/workspace/spring-mvn-pipeline/target/login.jar root@43.204.215.78:~/'
                ...
                sh "ssh root@43.204.215.78 'docker build -t login .'"
                sh "ssh root@43.204.215.78 'docker run -it -d -p 9090:9090 --name login login'"
            }
        }
    }
}
